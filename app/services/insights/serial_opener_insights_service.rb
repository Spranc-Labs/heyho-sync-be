...
module Insights
  ...
  class SerialOpenerInsightsService < BaseService
    ...
    def call
      ...
      calculator = AdaptiveThresholdCalculator.new(days_in_period: days)
    ...
    def detect_serial_openers_for_period(date_range, calculator)
      ...
      SerialOpenerDetectionService.call(
        user,
        days_in_period: days,
    ...
    def calculate_comparison(current_range, calculator, current_openers)
      ...
      comparison_data = ComparisonCalculator.calculate(current_openers, enriched_previous)
